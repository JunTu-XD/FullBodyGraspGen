...
python eval_grasppose.py --exp_name diffusion_eval --male_pose_ckpt_path saga_pretrained_model/saga_16_pretrain.pt --n_object_samples 5 --n_rand_samples_per_object 5 --gender male --diffusion_model_path usable_diffusion_ckpt/dim16_heads2_depth2.pt 
```
